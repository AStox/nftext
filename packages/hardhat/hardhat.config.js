...
module.exports = {
  ...
  networks: {
    ...
    ropsten: {
      url: "https://ropsten.infura.io/v3/5328972048ad4c9082cb2b4ebcc428f6", // <---- YOUR INFURA ID! (or it won't work)
      accounts: [`${process.env.ROPSTEN_PRIVATE_KEY}`]
      //      url: "https://speedy-nodes-nyc.moralis.io/XXXXXXXXXXXXXXXXXXXXXXXXX/eth/ropsten",// <---- YOUR MORALIS ID! (not limited to infura)
      
    },
    goerli: {
      url: "https://goerli.infura.io/v3/5328972048ad4c9082cb2b4ebcc428f6", // <---- YOUR INFURA ID! (or it won't work)
